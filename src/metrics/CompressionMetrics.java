...
public class CompressionMetrics {
    ...
    public String formatResults(Map<String, Double> metrics, double encodingTime, double decodingTime) {
        ...
        sb.append("Original size: ").append(String.format("%d", metrics.get("originalSize").longValue()))
                .append(" bytes\n");
        sb.append("Compressed size: ").append(String.format("%d", metrics.get("compressedSize").longValue()))
                .append(" bytes\n");


        sb.append("Compression ratio: ").append(String.format("%.4f", metrics.get("compressionRatio")))
                .append(" (higher is better)\n");
        sb.append("Average code length: ").append(String.format("%.4f", metrics.get("averageCodeLength")))
                .append(" bits/symbol\n");
